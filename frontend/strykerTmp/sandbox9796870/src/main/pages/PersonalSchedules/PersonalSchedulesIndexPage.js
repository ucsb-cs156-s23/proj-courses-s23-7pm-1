...
export default function PersonalSchedulesIndexPage() {
  if (stryMutAct_9fa48("525")) {
    ...
    ["/api/personalschedules/all"], stryMutAct_9fa48("528") ? {} : (stryCov_9fa48("528"), {
      method: stryMutAct_9fa48("529") ? "" : (stryCov_9fa48("529"), "GET"),
      url: stryMutAct_9fa48("530") ? "" : (stryCov_9fa48("530"), "/api/personalschedules/all")
    }), stryMutAct_9fa48("531") ? ["Stryker was here"] : (stryCov_9fa48("531"), []));
    return <BasicLayout>
            <div className="pt-2">
