...
export default function PersonalSchedulesIndexPage() {
  if (stryMutAct_9fa48("544")) {
    ...
    ["/api/personalschedules/all"], stryMutAct_9fa48("547") ? {} : (stryCov_9fa48("547"), {
      method: stryMutAct_9fa48("548") ? "" : (stryCov_9fa48("548"), "GET"),
      url: stryMutAct_9fa48("549") ? "" : (stryCov_9fa48("549"), "/api/personalschedules/all")
    }), stryMutAct_9fa48("550") ? ["Stryker was here"] : (stryCov_9fa48("550"), []));
    return <BasicLayout>
            <div className="pt-2">
