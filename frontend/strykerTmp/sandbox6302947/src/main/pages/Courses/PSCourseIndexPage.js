...
export default function CoursesIndexPage() {
  if (stryMutAct_9fa48("497")) {
    ...
    ["/api/courses/user/all"], stryMutAct_9fa48("500") ? {} : (stryCov_9fa48("500"), {
      method: stryMutAct_9fa48("501") ? "" : (stryCov_9fa48("501"), "GET"),
      url: stryMutAct_9fa48("502") ? "" : (stryCov_9fa48("502"), "/api/courses/user/all")
