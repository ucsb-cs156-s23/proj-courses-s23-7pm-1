...
export default function PersonalSchedulesTable({
  personalSchedules,
  showButtons = stryMutAct_9fa48("232") ? false : (stryCov_9fa48("232"), true)
}) {
  if (stryMutAct_9fa48("233")) {
    ...
    const editCallback = cell => {
      if (stryMutAct_9fa48("234")) {
        ...
        stryCov_9fa48("234");
        navigate(stryMutAct_9fa48("235") ? `` : (stryCov_9fa48("235"), `/personalschedules/edit/${cell.row.values.id}`));
      }
    };
    ...
    const detailsCallback = cell => {
      if (stryMutAct_9fa48("236")) {
        ...
        stryCov_9fa48("236");
        navigate(stryMutAct_9fa48("237") ? `` : (stryCov_9fa48("237"), `/personalschedules/details/${cell.row.values.id}`));
      }
